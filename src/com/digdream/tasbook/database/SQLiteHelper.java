...
public class SQLiteHelper extends SQLiteOpenHelper {
	...
	/** 数据库名称*/
	private final static String NAME = "mybook.db";
	private final static int DATABASE_VERSION = 1;
	private final static String SQL_CREATE_FILES = "CREATE TABLE \"mybook\" (" + //
	    FilesColumns.COL_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + //
	    FilesColumns.COL_ISBN10 + " TEXT," + //
	    FilesColumns.COL_ISBN13 + " TEXT," + //
	    FilesColumns.COL_NAME + " TEXT," + //
	    FilesColumns.COL_AUTHOR + " TEXT," + //
	    FilesColumns.COL_SUMMARY + " TEXT," + //
	    FilesColumns.COL_PUBLISHER + " TEXT," + //
	    FilesColumns.COL_IMAGE + " TEXT" + //
	    FilesColumns.COL_CLASSIFY + " TEXT" + //
	    ")";
...
//		delete("files", "1=1");
		String count = exeScalar("SELECT COUNT(_id) FROM mybook");
